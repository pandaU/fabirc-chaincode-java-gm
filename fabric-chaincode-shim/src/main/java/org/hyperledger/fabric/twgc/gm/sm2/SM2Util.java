package org.hyperledger.fabric.twgc.gm.sm2;
...
import org.hyperledger.fabric.twgc.gm.Const;
import org.hyperledger.fabric.twgc.gm.random.SecureRandomFactory;
...
public class SM2Util {
    ...
    public static X509Certificate loadX509CertificateFromStream(InputStream inputStream) throws  CertificateException,
            NoSuchProviderException {
        try {
            Security.addProvider(new BouncyCastleProvider());
        } catch (Exception e) {
