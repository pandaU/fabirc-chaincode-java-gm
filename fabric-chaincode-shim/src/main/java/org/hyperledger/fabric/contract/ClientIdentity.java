...
import org.hyperledger.fabric.twgc.gm.sm2.SM2Util;
...
public final class ClientIdentity {
     ...
     * @throws IOException
     */
    public ClientIdentity(final ChaincodeStub stub) throws CertificateException, JSONException, IOException, NoSuchProviderException {
        ...
        final X509Certificate cert = SM2Util.loadX509CertificateFromStream(new ByteArrayInputStream(idBytes));
        this.cert = cert;
